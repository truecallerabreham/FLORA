...
def make_edge_condition(type="always", field=None, operator=None, value=None):
    from forla.workflow.core import EdgeCondition
...
class TestWorkflowSerialization:
    ...
    def test_workflow_serialization_roundtrip(self, sample_workflow):
        ...
        assert config.provider == "forla.workflow.Workflow"
...
from forla.workflow.core import StepMetadata, Workflow, WorkflowRunner
...
def make_slow_workflow():
    from forla.workflow.core import WorkflowMetadata
...
class TestTransformStep:
    def test_transform_step_valid_mapping(self):
        ...
        from forla.workflow.core import Context
